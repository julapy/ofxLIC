...
void ofxStreamline :: setVectorData ( ofPoint* vecField, int vecFieldW, int vecFieldH )
{
...
void ofxStreamline :: RK ( ofxVec2f &p, double h )
{
    ofxVec2f v;
    ofxVec2f k1, k2, k3, k4;
...
ofxVec2f ofxStreamline :: getVector( const ofPoint &p )
{
    ofxVec2f v;
    ...
    return ofxVec2f( vecField[ i ].x, vecField[ i ].y );
}
...
void ofxStreamline :: drawStrip ( bool bSmooth )
{
    ...
    for( int i=0; i<t; i++ )
    {
        ...
        ofxVec2f p1 = ofxVec2f( points[ i ] );
        ofxVec2f p2 = ofxVec2f( points[ j ] );
...
void ofxStreamline :: drawDots ()
{
    ...
    for( int i=0; i<t; i++ )
    {
        ...
        ofSetColor( 255 * c, 255 * c, 255 * c, 255 );
